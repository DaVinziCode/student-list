        ...
        <section class="mt-5">
            <form action="/add/student" method="POST" class="flex flex-col">
                ...
                <div class="mb-6 pt-3 rounded bg-gray-200">
                    ...
                    <input type="text" name="first_name" id="" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-400 px-3" autocomplete="off" value="{{old('first_name')}}">
                    @error('first_name')
